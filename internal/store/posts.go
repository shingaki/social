...
// this is the model and you can move it to another folder - model - if following MVC foldder structure
type Post struct {
	ID        int64     `json:"id"`
...
func (s *PostStore) GetUserFeed(ctx context.Context, userID int64, fq PaginatedFeedQuery) ([]PostWithMetadata, error) {
	...
	log.Println(query)
	log.Println(userID, fq.Limit, fq.Offset, fq.Search, fq.Tags)
